...
namespace ERPIntegration
{
    public partial class importCSV
    {
        ...
        private void openGPSQL()
        {
            ...
            {
                MessageBox.Show("Error opening GP SQL Connection. Full error: \n" + sqlException.ToString());
            }
        }

        private void openADSKSQL()
        {
            try
            {
                adsksql.Open();
            ...
            {
                MessageBox.Show("Error opening ADSK SQL Connection. Full error: \n" + sqlException.ToString());
            }
        }

        private void closeGPSQL()
        {
            gpsql.Close();
        }

        private void closeADSKSQL()
        {
            adsksql.Close();
        }
        ...
        public void addBoMLineTemp(part linePart)
        {
            ...
            if (linePart.position != "")
            {
                try
                {
                    ...
                    myCommand.Parameters.AddWithValue("@SubCat", linePart.subcat);
